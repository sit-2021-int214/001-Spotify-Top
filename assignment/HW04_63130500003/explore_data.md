...
หลังจากที่เราทราบข้อมูลเบื้องต้นของข้อมูลชุดนี้แล้ว ต่อไปเราจะทำการหาข้อมูลเชิงลึกและอธิบายฟังก์ชันที่ไม่เคยเรียนในห้องกัน ซึ่งจะอยู่ใน [Part 2](https://github.com/sit-2021-int214/001-Spotify-Top/blob/main/assignment/HW04_63130500003/find_insight_data.md) 
